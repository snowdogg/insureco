    ...
    <Stack gap={0} className="tlp">
      ...
      <section className="tlp__features">
        <Stack gap={10} align="center" className="tlp__features-stack">
          ...
          <Grid className="tlp__feature-tiles" fullWidth>
            {FEATURES.map((feature) => (
              <Column key={feature.title} sm={4} md={4} lg={5} className="tlp__feature-col">
                <Tile className="tlp__feature-tile">
                  <Stack gap={5}>
      ...
      <section className="tlp__faq">
        <Stack gap={8} align="center" className="tlp__faq-stack">
      ...
      <footer className="tlp__footer">
        <Stack gap={8}>
          <Grid className="tlp__footer-inner" fullWidth>
            <Column sm={4} md={8} lg={7} className="tlp__footer-newsletter-col">
              <Stack gap={5} className="tlp__footer-newsletter">
            ...
            {Object.entries(FOOTER_LINKS).map(([section, links]) => (
              <Column key={section} sm={4} md={2} lg={3} className="tlp__footer-links-col">
                <Stack gap={4} className="tlp__footer-links">
                  <h4 className="tlp__footer-links-title">{section}</h4>
                  <ul className="tlp__footer-link-list">
                    {links.map((link) => (
                      <li key={link}>
                        <Link href="#" className="tlp__footer-link">
                          {link}
                        </Link>
                      </li>
                    ))}
          ...
          <Stack orientation="horizontal" gap={5} className="tlp__footer-bottom">
            <Stack orientation="horizontal" gap={3} className="tlp__footer-legal">
              <Link href="#" className="tlp__footer-legal-link">
                Privacy Policy
              </Link>
            ...
            <Stack orientation="horizontal" gap={3} className="tlp__footer-socials">
              ...
              <Link href="#" className="tlp__social-icon" aria-label="X (Twitter)">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="#" className="tlp__social-icon" aria-label="LinkedIn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
