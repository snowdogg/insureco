  ...
  return (
    <div className="test-landing">
      ...
      <section className="tl-hero">
        <Grid>
          <Column lg={{ span: 10, offset: 3 }} md={8} sm={4}>
            <Heading className="tl-hero__heading">Our latest</Heading>
            ...
            <p className="tl-hero__terms">
              ...
              <Link href="#terms" className="tl-hero__terms-link">Terms and Conditions</Link>
            </p>
          </Column>
        ...
        <Grid>
          <Column lg={{ span: 10, offset: 3 }} md={8} sm={4}>
            <div className="tl-features__intro">
              <Heading className="tl-section-heading">Product features</Heading>
          ...
          {FEATURES.map((feat) => (
            <Column lg={5} md={4} sm={4} key={feat.title} className="tl-features__col-card">
              <Tile className="tl-feature-card">
                ...
                <Heading className="tl-feature-card__title">{feat.title}</Heading>
        ...
        <Grid>
          <Column lg={{ span: 10, offset: 3 }} md={8} sm={4}>
            <div className="tl-testimonials__header">
              <Heading className="tl-section-heading tl-section-heading--light">Testimonials</Heading>
          ...
          {TESTIMONIALS.map((t, i) => (
            <Column lg={5} md={4} sm={4} key={i} className="tl-testimonials__col-card">
              <Tile className="tl-testimonial-card">
      ...
      <section className="tl-faq">
        <Grid>
          <Column lg={16} md={8} sm={4}>
            <Heading className="tl-section-heading">Frequently asked questions</Heading>
          </Column>
      ...
      <footer className="tl-footer">
        <Grid className="tl-footer__main">
          <Column lg={5} md={3} sm={4}>
            <div className="tl-footer__brand">
              ...
              <Heading className="tl-footer__newsletter-heading">Join the newsletter</Heading>
            ...
            <div className="tl-footer__links">
              {Object.entries(FOOTER_LINKS).map(([category, links]) => (
                <div key={category} className="tl-footer__link-col">
                  <Heading className="tl-footer__link-heading">{category}</Heading>
                  <ul className="tl-footer__link-list">
                    {links.map((link) => (
                      <li key={link}>
                        <Link href="#" className="tl-footer__link">{link}</Link>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <Grid>
            <Column lg={8} md={4} sm={4}>
              <div className="tl-footer__bottom-left">
                <Link href="#" className="tl-footer__bottom-link">Privacy Policy</Link>
                <span className="tl-footer__bottom-sep">&bull;</span>
                <Link href="#" className="tl-footer__bottom-link">Terms of Service</Link>
                <span className="tl-footer__bottom-sep">&bull;</span>
            ...
            <Column lg={8} md={4} sm={4}>
              <div className="tl-footer__social">
                <Link href="#" className="tl-footer__social-link" aria-label="GitHub">
                ...
                <Link href="#" className="tl-footer__social-link" aria-label="X (Twitter)">
                  <div className="tl-footer__social-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                ...
                <Link href="#" className="tl-footer__social-link" aria-label="LinkedIn">
                  <div className="tl-footer__social-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
